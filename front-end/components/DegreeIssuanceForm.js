...
const DegreeIssuanceForm = () => {
  ...
  const issueDegree = async (e) => {
    ...
    await contract.methods
      .issueDegree(studentAddressEl.current.value)
      .send({
        from: account,
      })
      ...
      .then((res) => {
        ...
        setTxCompleted(true)
        setTxMessage(
          ` ${txMessage} The transaction is now on chain and mined in block ${res.blockNumber}. Successful! 🎉 Degree issued.`
        )
      })
  }
...
export default DegreeIssuanceForm
